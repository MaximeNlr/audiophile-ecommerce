            ...
            >
                ...
                {isSubmitted &&
                    <div className="fixed inset-0 bg-black/50 z-40">
                        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-between bg-white text-black w-[90%]
                                h-[600px] md:w-[540px] md:h-[581px] px-10 py-10 rounded-lg shadow-lg z-50 overflow-y-auto">
                            ...
                            <div className="flex flex-row w-full h-[140px] rounded-lg">
                                <div className="flex flex-col justify-center gap-3 px-5 bg-[var(--custom-grey)] h-[140px] w-full rounded-l-lg">
                                    <div className="flex flex-row items-center justify-between">
                                        <div className="flex flex-row gap-1">
                                            ...
                                            <div className="flex-flex-row">
                                                <p className="font-semibold">{cart[0].product.slug2}</p>
                                ...
                                <div className="flex flex-col px-10 gap-3 justify-center bg-[var(--custom-black)] text-white w-full rounded-r-lg">
                                    <p className="opacity-50">GRAND TOTAL</p>
